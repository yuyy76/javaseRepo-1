package cn.yyy.day12.demo03;

import java.util.Arrays;

/*
java.lang.System类中提供了大量的静态方法，可以获取与系统相关的信息或系统级的操作，在System类的API文档中，常用的方法有：
...
//        demo01();
     ...
     *      length - 要复制的数组元素的数量。
     *  练习：
     *      将src数组中前3个元素，复制到desc数组的前3个位置上。复制元素前：src数组元
     *      素[1,2,3,4,5],desc数组元素[6,7,8,9,10];复制元素后：src数组元素[1,2,
     *      3,4,5],desc数组元素[1,2,3,9,10]
     */
